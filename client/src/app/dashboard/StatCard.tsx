...
const StatCard = ({
  ...
  return (
    <div className="md:row-span-1 xl:row-span-2 bg-white col-span-1 shadow-md flex flex-col justify-between">
      <div>
      ...
      {/* BODY */}
      <div className="flex mb-6 items-center justify-arround gap-4 px-5">
