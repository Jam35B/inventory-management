...
const CardSalesSummary = () => {
  ...
  // Agregar log para ver la estructura de los datos
  console.log("API Data:", data);

  const salesData = data?.salesSummary || []; // Manejar el caso donde salesSummary esté vacío o no exista
  ...
  if (isError) {
    return <div className="m-5">Fallo al indexar la data</div>;
  }
